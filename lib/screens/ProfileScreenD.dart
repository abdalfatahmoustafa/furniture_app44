...
class ProfileScreenD extends StatefulWidget {
  const ProfileScreenD({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        CircleAvatar(
                          backgroundImage: NetworkImage(
                            context.watch<DriverProvider>().driver.photoUrl!,
                          ),
                          radius: 40,
                        ),
                        SizedBox(
                        ...
                        Padding(
                          ...
                          child: Text(
                            context.watch<DriverProvider>().driver.name!,
                            style: TextStyle(
                                fontSize: 16,
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(
                            context.watch<DriverProvider>().driver.email!,
